...
class CariRaporService:
    ...
    def get_durum_raporu():
        ...
        # DÜZELTME: Dahili sistem firmaları rapor listesinden ve genel toplamdan dışlandı!
        ...
        # DÜZELTME: 'net' anahtarı HTML şablonuyla uyumlu olması için 'bakiye' olarak değiştirildi
        return rapor, {'borc': g_borc, 'alacak': g_alacak, 'bakiye': g_borc - g_alacak}